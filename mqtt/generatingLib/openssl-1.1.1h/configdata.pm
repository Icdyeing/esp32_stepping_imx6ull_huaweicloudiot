...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/home/icdyeing/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssldir => "/home/icdyeing/MQTT/openssl-1.1.1h/ssl",
  options => "enable-shared --prefix=/home/icdyeing/MQTT/openssl-1.1.1h --openssldir=/home/icdyeing/MQTT/openssl-1.1.1h/ssl --cross-compile-prefix=/home/icdyeing/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf- no-afalgeng no-asan no-asm no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.22.1",
  perlargv => [ "linux-x86_64", "no-asm", "shared", "--prefix=/home/icdyeing/MQTT/openssl-1.1.1h", "--openssldir=/home/icdyeing/MQTT/openssl-1.1.1h/ssl", "--cross-compile-prefix=/home/icdyeing/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/icdyeing/MQTT/openssl-1.1.1h",
  processor => "",
